<?php
// Iniciar sesión para identificar al paciente
...
?>
<h1>Paciente</h1>
<p class ="text-light p-4"><?php echo "Bienvenido  ". $_SESSION['nombre'];?></p>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <main>
        ...
        if (isset($_GET['page'])) {
            ...
            switch ($page) {
                case 'cita_actual':
                    include 'current_appointment.php';
                    break;
                case 'doctor_asignado':
                    include 'assigned_doctor.php';
                    break;
                case 'historial':
                    include 'appointment_history.php';
                    break;
                default:
                    echo "<h2>Bienvenido al Panel del Paciente</h2>";
            }
        } else {
            echo "<h2>Bienvenido al Panel del Paciente</h2>";
        }
    ...
    <footer>
        <p>&copy; 2024 Sistema de Gestión de Pacientes</p>
    </footer>
</body>
</html>
